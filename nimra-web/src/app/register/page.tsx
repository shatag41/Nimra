  ...
  return (
    <AuthPageWrapper className="register-page">
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .register-page .auth-card-header h2 {
          margin-bottom: 0.3rem !important;
        }
        .register-page.auth-mobile-flow .auth-form > .register-fields-grid {
      ...
      <div className="auth-shell glass">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <div className="register-fields-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.6vh 1vw' }}>
            ...
            <div className="auth-field" style={{ gridColumn: '1 / -1', width: '70%' }}>
              ...
              <div className="auth-input-wrapper" style={{ position: 'relative' }}>
                <input id="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} placeholder="Confirm password" className="auth-input" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required style={{ paddingRight: '2.5rem', width: '100%', boxSizing: 'border-box' }} />
                <button
                  type="button"
