...
export function CatalogCard({ product, onAdd }: ProductCardProps) {
...
export function RecommendationCard({ product, onAdd }: ProductCardProps) {
...
export function PreviewCard({ product, index }: ProductCardProps & { index: number }) {
  const orderable = isOrderable(product);
  return (
