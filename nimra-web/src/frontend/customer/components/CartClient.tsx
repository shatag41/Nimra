...
const styles = `
  ...
  .cart-hero { position:relative; isolation:isolate; overflow:hidden; min-height:clamp(88px,10vw,118px); display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; padding:clamp(1rem,2.5vw,1.75rem) 1rem; border:1px solid var(--cart-border); border-radius:24px; background:linear-gradient(135deg,rgba(255,255,255,.8),rgba(239,246,255,.7)); box-shadow:0 18px 55px rgba(15,23,42,.07); }
