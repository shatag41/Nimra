// India: states + cities mapping data
...
export const ALL_STATES = Object.keys(INDIA_DATA).sort();
export const fetchPincodeData = async (pincode: string): Promise<{ state: string; city: string } | null> => {
  try {
