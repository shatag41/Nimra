...
export default function Sidebar({ currentUser, activeTab, setActiveTab, isProfilePanelOpen, isMobileOpen, onToggleMobile, onEditProfile, onLogout }: SidebarProps) {
  ...
  return <aside id="admin-mobile-sidebar" className={`admin-sidebar glass ${isMobileOpen ? 'mobile-open' : ''} ${isProfilePanelOpen ? 'blur-background' : ''}`}>
    <div className="sidebar-brand desktop-sidebar-brand"><div className="sidebar-logo-icon"><svg width="28" height="28" viewBox="0 0 100 100" fill="none"><path d="M50 5S15 45 15 65c0 19.33 15.67 35 35 35s35-15.67 35-35C85 45 50 5 50 5Z" fill="url(#sidebarNGrad)"/><text x="50" y="77" textAnchor="middle" fontSize="34" fill="white">N</text><defs><linearGradient id="sidebarNGrad" x1="50" y1="5" x2="50" y2="100"><stop stopColor="#3b82f6"/><stop offset="1" stopColor="#2563eb"/></linearGradient></defs></svg></div><span className="brand-text">NIMRA</span></div>
