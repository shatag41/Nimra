...
export default function SuperAdminDashboard({ orders, users, products, inquiries, cancellationRequests, notifications, onNavigate, onOpenCancellationRequests }: Props) {
  ...
  return <div className="enterprise-section command-center">
    <LiveEventsBar notifications={notifications} orders={orders} inquiries={inquiries} cancellationRequests={cancellationRequests} onNavigate={onNavigate} onOpenCancellationRequests={onOpenCancellationRequests}/>
